...
<img src="./assets/terminal.svg" width="100%" alt="Terminal session: whoami returns Nazmul Hasan, role is Full Stack Software Engineer, stack is Next.js, React, Laravel, TypeScript and PHP, focus is scalable architecture, secure backends and performance-driven interfaces."/>
...
<img src="./assets/architecture.svg" width="100%" alt="Architecture diagram: client requests flow through Next.js or React into an API layer, Laravel services and MySQL or MongoDB storage, while a queue drives driver-based notifications over email, SMS and push."/>

<img src="./assets/divider.svg" width="100%" alt="Section divider"/>

## TECHNOLOGY ECOSYSTEM

<img src="./assets/tech-orbit.svg" width="100%" alt="Technology ecosystem orbiting Full Stack Engineering: frontend Next.js, React, TypeScript, JavaScript, Tailwind CSS; backend Laravel, PHP, Symfony, Livewire, Filament; data MySQL, MariaDB, MongoDB, Redis; engineering Docker, Git, GitHub Actions, Postman, Socket.io."/>
...
<img src="https://github-readme-activity-graph.vercel.app/graph?username=nazmulhasan1010&bg_color=0D1D30&color=A8C0D8&line=0EA5E9&point=38BDF8&area=true&area_color=0D2B45&hide_border=true" width="100%" alt="Contribution activity graph for the last year"/>
